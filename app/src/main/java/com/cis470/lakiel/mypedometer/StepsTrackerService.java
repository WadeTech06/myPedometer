...
public class StepsTrackerService extends Service {
    ...
    private static int WALKINGPEAK = 18;
    private static int JOGGINGPEAK = 25;
    private static int RUNNINGPEAK = 32;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        WALKINGPEAK = intent.getIntExtra("wPeak", 18);
        JOGGINGPEAK = intent.getIntExtra("jPeak", 25);
        RUNNINGPEAK = intent.getIntExtra("rPeak",32);
